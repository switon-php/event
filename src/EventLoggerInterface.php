...
{
    /**
     * Return the default log category for one event class.
     *
     * Same rule as runtime when the event does not implement Categorizable.
     * Beacon CLI: <code>event:category</code> / <code>event:by-code</code>.
     */
    public function categoryForClass(string $eventClass): string;

    /**
     * Register the logger listener and emit the bootstrap status log.
     */
