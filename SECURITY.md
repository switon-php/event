...
Security fixes are provided for **currently supported release lines** of `switon/event` (`switon/event` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/event/security/advisories/new)
